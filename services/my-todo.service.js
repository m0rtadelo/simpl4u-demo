...
export class MyTodoService {
  ...
  static async saveData(model = MyTodoService.context.model) {
    ...
    await StorageService.saveApp(MyTodoService.context.context, model || MyTodoService.context.model);
  }
  ...
  static async loadData() {
    return await StorageService.loadApp(MyTodoService.context.context) || {};
  }
